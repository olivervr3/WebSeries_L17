...
namespace Web
{
    public partial class SeriesPendientes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ENSeriesPendientes pen = new ENSeriesPendientes();
            pen.usuarioPendiente = usu.IDUsuario();


            ENSerie[] listaEn = pen.readPendientes();
